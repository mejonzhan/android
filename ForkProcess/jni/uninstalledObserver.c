...
static const char APP_DIR[] = "/data/data/com.example.forkprocess";
static const char APP_FILES_DIR[] = "/data/data/com.example.forkprocess/files";
static const char APP_OBSERVED_FILE[] = "/data/data/com.example.forkprocess/files/observedFile";
static const char APP_LOCK_FILE[] = "/data/data/com.example.forkprocess/files/lockFile";
/* 内全局变量 */

JNIEXPORT int JNICALL Java_com_example_forkprocess_UninstalledObserverActivity_init(JNIEnv *, jobject, jstring);


/*
 * Class:     Java_com_example_forkprocess_UninstalledObserverActivity_init
 * Method:    init
 * Signature: ()V
 * return: 子进程pid
 */
JNIEXPORT int JNICALL Java_com_example_forkprocess_UninstalledObserverActivity_init(JNIEnv *env, jobject obj, jstring userSerial)
{
    ...
    else if (pid == 0)
    {
        ...
        if (userSerial == NULL)
        {
            ...
            execlp("am", "am", "start", "-a", "android.intent.action.VIEW", "-d", "http://www.bing.com", (char *)NULL);
        }
        else
        {
